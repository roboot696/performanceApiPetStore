...
import {host , port, storeService, apiVersion, petService, payload} from './constants.js'
...
export default function () {
  const response = http.get(`http://${host}:${port}${apiVersion}${petService}`, payload, {headers: {Accepts: "application/json"}});
